  ...
  return (
    <section id='private-policy'>
      <div>
        ...
        cookies. 1. Informacje ogólne 1. Niniejsza polityka dotyczy Serwisu www,
        funkcjonującego pod adresem url: www.plusdlaurody.pl 2. Operatorem
        serwisu oraz Administratorem danych osobowych jest: Jan Kominki Jan
        Andruszczak www.plusdlaurody.pl 3. Adres kontaktowy poczty
        elektronicznej operatora: plusdlaurody@gmail.com 4. Operator jest
        Administratorem Twoich danych osobowych w odniesieniu do danych podanych
        dobrowolnie w Serwisie. 5. Serwis wykorzystuje dane osobowe w
        następujących celach: o Obsługa zapytań przez formularz o Prezentacja
        oferty lub informacji 6. Serwis realizuje funkcje pozyskiwania
        informacji o użytkownikach i ich zachowaniu w następujący sposób: o
        Poprzez dobrowolnie wprowadzone w formularzach dane, które zostają
        wprowadzone do systemów Operatora. o Poprzez zapisywanie w urządzeniach
        końcowych plików cookie (tzw. „ciasteczka”). 2. Wybrane metody ochrony
        danych stosowane przez Operatora 1. Istotnym elementem ochrony danych
        jest regularna aktualizacja wszelkiego oprogramowania, wykorzystywanego
        przez Operatora do przetwarzania danych osobowych, co w szczególności
        oznacza regularne aktualizacje komponentów programistycznych. 3. Hosting
        1. Serwis jest hostowany (technicznie utrzymywany) na serwera operatora:
        ovh.com 4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania
        danych 1. W niektórych sytuacjach Administrator ma prawo przekazywać
        ...
        celu realizacji celu działania strony 2. Twoje dane osobowe przetwarzane
        ...
        nie będą przetwarzane dłużej niż przez 3 lata. 3. Przysługuje Ci prawo
        żądania od Administratora: o dostępu do danych osobowych Ciebie
        dotyczących, o ich sprostowania, o usunięcia, o ograniczenia
        przetwarzania, o oraz przenoszenia danych. 4. Przysługuje Ci prawo do
        ...
        dochodzenia lub obrony roszczeń. 5. Na działania Administratora
        przysługuje skarga do Prezesa Urzędu Ochrony Danych Osobowych, ul.
        Stawki 2, 00-193 Warszawa. 6. Podanie danych osobowych jest dobrowolne,
        lecz niezbędne do obsługi Serwisu. 7. W stosunku do Ciebie mogą być
        podejmowane czynności polegające na zautomatyzowanym podejmowaniu
        decyzji, w tym profilowaniu w celu świadczenia usług w ramach zawartej
        umowy oraz w celu prowadzenia przez Administratora marketingu
        bezpośredniego. 8. Dane osobowe nie są przekazywane od krajów trzecich w
        rozumieniu przepisów o ochronie danych osobowych. Oznacza to, że nie
        przesyłamy ich poza teren Unii Europejskiej. 5. Informacje w
        formularzach 1. Serwis zbiera informacje podane dobrowolnie przez
        użytkownika, w tym dane osobowe, o ile zostaną one podane. 2. Serwis
        może zapisać informacje o parametrach połączenia (oznaczenie czasu,
        adres IP). 3. Serwis, w niektórych wypadkach, może zapisać informację
        ...
        pojawia się wewnątrz adresu url strony zawierającej formularz. 4. Dane
        ...
        służy. 6. Logi Administratora 1. Informacje zachowaniu użytkowników w
        serwisie mogą podlegać logowaniu. Dane te są wykorzystywane w celu
        administrowania serwisem. 7. Istotne techniki marketingowe 1. Operator
        stosuje analizę statystyczną ruchu na stronie, poprzez Google Analytics
        (Google Inc. z siedzibą w USA). Operator nie przekazuje do operatora tej
        usługi danych osobowych, a jedynie zanonimizowane informacje. Usługa
        ...
        https://www.google.com/ads/preferences/ 2. Operator stosuje techniki
        ...
        jest włączona obsługa plików cookie. 3. Operator stosuje korzysta z
        piksela Facebooka. Ta technologia powoduje, że serwis Facebook (Facebook
        Inc. z siedzibą w USA) wie, że dana osoba w nim zarejestrowana korzysta
        z Serwisu. Bazuje w tym wypadku na danych, wobec których sam jest
        ...
        ciasteczek w urządzeniu końcowym użytkownika. 4. Operator stosuje
        ...
        nie podlegają wpisywane hasła oraz inne dane osobowe. 5. Operator
        stosuje rozwiązanie automatyzujące działanie Serwisu w odniesieniu do
        ...
        korespondencji handlowej od Operatora. 6. Operator może stosować
        profilowanie w rozumieniu przepisów o ochronie danych osobowych 8.
        Informacja o plikach cookies 1. Serwis korzysta z plików cookies. 2.
        ...
        końcowym oraz unikalny numer. 3. Podmiotem zamieszczającym na urządzeniu
        końcowym Użytkownika Serwisu pliki cookies oraz uzyskującym do nich
        dostęp jest operator Serwisu. 4. Pliki cookies wykorzystywane są w
        następujących celach: 1. utrzymanie sesji użytkownika Serwisu (po
        zalogowaniu), dzięki której użytkownik nie musi na każdej podstronie
        Serwisu ponownie wpisywać loginu i hasła; 2. realizacji celów
        określonych powyżej w części „Istotne techniki marketingowe”; 5. W
        ...
        jest także automatyczne blokowanie plików cookies Szczegółowe informacje
        ...
        funkcjonalności dostępne na stronach internetowych Serwisu. 8. Pliki
        ...
        (Twitter Inc. z siedzibą w USA). 9. Zarządzanie plikami cookies – jak w
        praktyce wyrażać i cofać zgodę? 1. Jeśli użytkownik nie chce otrzymywać
        ...
        ze stron www 2. W celu zarządzania ustawienia cookies wybierz z listy
        poniżej przeglądarkę internetową, której używasz i postępuj zgodnie z
        instrukcjami: o Edge o Internet Explorer o Chrome o Safari o Firefox o
        Opera Urządzenia mobilne: o Android o Safari (iOS) o Windows Phone
      </div>
      <ContactSection />
    </section>
  );
